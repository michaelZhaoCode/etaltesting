...
<head>
  ...
  <meta content="People" property="twitter:title">
...
" height="33" class="brandlogoimage"></a>
  ...
  <section class="blogsection">
    <div class="page-padding-5">
      <div class="container-large-3">
        <div class="padding-vertical-xhuge-3">
          <div class="blogsection09_component">
  ...
  <div class="footer">
    <div class="w-layout-grid grid">
      <div id="w-node-de7d164e-4cba-062c-cd51-30103eebb0f1-35bbf1e4" class="footercontactdiv">
      ...
      <a id="w-node-de7d164e-4cba-062c-cd51-30103eebb0fd-35bbf1e4" href="https://www.vic.utoronto.ca/subscribe-to-our-mailing-list/" target="_blank" class="footersubscribebutton w-inline-block">
        <div class="text-block-13">Subscribe to our mailing list</div>
      </a>
      <div id="w-node-de7d164e-4cba-062c-cd51-30103eebb100-35bbf1e4" class="socialsdiv">
        <div class="w-layout-grid grid-2">
          <a id="w-node-de7d164e-4cba-062c-cd51-30103eebb102-35bbf1e4" href="https://www.linkedin.com/school/university-of-toronto---victoria-university/" target="_blank" class="w-inline-block"><img src="images/linkedin-in.svg" loading="lazy" alt="linkedin icon" class="linkedinlogo"></a>
          <a id="w-node-de7d164e-4cba-062c-cd51-30103eebb104-35bbf1e4" href="https://twitter.com/VicCollege_UofT" target="_blank" class="w-inline-block"><img src="images/x-twitter.svg" loading="lazy" alt="twitter icon" class="twitterlogo"></a>
          <a id="w-node-de7d164e-4cba-062c-cd51-30103eebb106-35bbf1e4" href="https://www.facebook.com/vicu.utoronto/" target="_blank" class="w-inline-block"><img src="images/square-facebook.svg" loading="lazy" alt="facebook icon" class="facebooklogo"></a>
          <a id="w-node-de7d164e-4cba-062c-cd51-30103eebb108-35bbf1e4" href="https://www.instagram.com/viccollege/" class="w-inline-block"><img src="images/instagram.svg" loading="lazy" alt="instagram icon" class="instalogo"></a>
        </div>
      </div>
      <div id="w-node-de7d164e-4cba-062c-cd51-30103eebb10a-35bbf1e4" class="copyrighttext">© 2023 Victoria University. All rights reserved.<br></div>
    </div>
  </div>
