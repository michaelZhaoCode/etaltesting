  ...
  <div class="section-4">
    <div class="container-4 w-container">
      <div class="centered-902">
        <h2><span class="text-span-3"><strong class="bold-text-6">About Us</strong></span></h2>
          ...
          <div id="w-node-_3214d116-5d95-e972-60de-5e1a92d055ef-d706d7c0" class="wrapped-team-card-3 top-aligned">
            ...
            <div class="team-member-details-3">
              ...
              <div class="w-layout-grid team01_social_2">
                <a href="http://individual.utoronto.ca/rmcewen/" target="_blank" class="social-link w-inline-block">
                ...
                <a href="mailto:rhonda.mcewen@utoronto.ca" target="_blank" class="social-link w-inline-block">
                  <div class="social-icon w-embed"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewbox="0 0 512 512">
                      <!-- ! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc.  -->
                      <style>svg{fill:#98a2b3}</style>
                ...
                <a href="https://scholar.google.ca/citations?user=ds2Z3GEAAAAJ&amp;hl=en" class="social-link w-inline-block">
                ...
                <a href="https://www.linkedin.com/in/rhondamcewen/" target="_blank" class="social-link w-inline-block">
                ...
                <a href="https://twitter.com/rhondamcewen?lang=en" target="_blank" class="social-link w-inline-block">
                  <div class="social-icon w-embed"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <?php
              ...
              $sql = "SELECT profilepic_url, bio_text, fullname, lab_role, interests, personal_url, email_url, googlescholar_url, linkedin_url, twitter_url FROM team_members";
              $result = $conn->query($sql);
          
              if ($result->num_rows > 0) {
                  while($row = $result->fetch_assoc()) {
                      echo '<div id="w-node-cfe9b421-3e54-21b7-9ee3-e9e8a86b3ca3-d706d7c0" class="team-member-item">';
                      ...
                      echo '<div class="text-size-medium-2 text-color-primary700">'.$row["lab_role"].'</div>';
                      echo '<div class="space-xxsmall"></div>';
                      echo '<div class="text-size-medium-2">'.$row["interests"].'</div>';
                      echo '<div class="w-layout-grid team01_social">';
                      
                      if (!empty($row["personal_url"])) {
                          echo '<a href="'.$row["personal_url"].'" class="social-link w-inline-block">';
                          echo '<div class="social-icon w-embed"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#98a2b3}</style><path d="M57.7 193l9.4 16.4c8.3 14.5 21.9 25.2 38 29.8L163 255.7c17.2 4.9 29 20.6 29 38.5v39.9c0 11 6.2 21 16 25.9s16 14.9 16 25.9v39c0 15.6 14.9 26.9 29.9 22.6c16.1-4.6 28.6-17.5 32.7-33.8l2.8-11.2c4.2-16.9 15.2-31.4 30.3-40l8.1-4.6c15-8.5 24.2-24.5 24.2-41.7v-8.3c0-12.7-5.1-24.9-14.1-33.9l-3.9-3.9c-9-9-21.2-14.1-33.9-14.1H257c-11.1 0-22.1-2.9-31.8-8.4l-34.5-19.7c-4.3-2.5-7.6-6.5-9.2-11.2c-3.2-9.6 1.1-20 10.2-24.5l5.9-3c6.6-3.3 14.3-3.9 21.3-1.5l23.2 7.7c8.2 2.7 17.2-.4 21.9-7.5c4.7-7 4.2-16.3-1.2-22.8l-13.6-16.3c-10-12-9.9-29.5 .3-41.3l15.7-18.3c8.8-10.3 10.2-25 3.5-36.7l-2.4-4.2c-3.5-.2-6.9-.3-10.4-.3C163.1 48 84.4 108.9 57.7 193zM464 256c0-36.8-9.6-71.4-26.4-101.5L412 164.8c-15.7 6.3-23.8 23.8-18.5 39.8l16.9 50.7c3.5 10.4 12 18.3 22.6 20.9l29.1 7.3c1.2-9 1.8-18.2 1.8-27.5zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256z"/></svg></div></a>';
                      }
                      if (!empty($row["email_url"])) {
                          echo '<a href="'.$row["email_url"].'" class="social-link w-inline-block">';
                          echo '<div class="social-icon w-embed"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#98a2b3}</style><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48H48zM0 176V384c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V176L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg></div></a>';
                      }
                      if (!empty($row["googlescholar_url"])) {
                          echo '<a href="'.$row["googlescholar_url"].'" class="social-link w-inline-block">';
                          echo '<div class="social-icon w-embed"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#98a2b3}</style><path d="M320 32c-8.1 0-16.1 1.4-23.7 4.1L15.8 137.4C6.3 140.9 0 149.9 0 160s6.3 19.1 15.8 22.6l57.9 20.9C57.3 229.3 48 259.8 48 291.9v28.1c0 28.4-10.8 57.7-22.3 80.8c-6.5 13-13.9 25.8-22.5 37.6C0 442.7-.9 448.3 .9 453.4s6 8.9 11.2 10.2l64 16c4.2 1.1 8.7 .3 12.4-2s6.3-6.1 7.1-10.4c8.6-42.8 4.3-81.2-2.1-108.7C90.3 344.3 86 329.8 80 316.5V291.9c0-30.2 10.2-58.7 27.9-81.5c12.9-15.5 29.6-28 49.2-35.7l157-61.7c8.2-3.2 17.5 .8 20.7 9s-.8 17.5-9 20.7l-157 61.7c-12.4 4.9-23.3 12.4-32.2 21.6l159.6 57.6c7.6 2.7 15.6 4.1 23.7 4.1s16.1-1.4 23.7-4.1L624.2 182.6c9.5-3.4 15.8-12.5 15.8-22.6s-6.3-19.1-15.8-22.6L343.7 36.1C336.1 33.4 328.1 32 320 32zM128 408c0 35.3 86 72 192 72s192-36.7 192-72L496.7 262.6 354.5 314c-11.1 4-22.8 6-34.5 6s-23.5-2-34.5-6L143.3 262.6 128 408z"/></svg></div></a>';
                      }
                      if (!empty($row["linkedin_url"])) {
                          echo '<a href="'.$row["linkedin_url"].'" class="social-link w-inline-block">';
                          echo '<div class="social-icon w-embed"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M22.2234 0H1.77187C0.792187 0 0 0.773438 0 1.72969V22.2656C0 23.2219 0.792187 24 1.77187 24H22.2234C23.2031 24 24 23.2219 24 22.2703V1.72969C24 0.773438 23.2031 0 22.2234 0ZM7.12031 20.4516H3.55781V8.99531H7.12031V20.4516ZM5.33906 7.43438C4.19531 7.43438 3.27188 6.51094 3.27188 5.37187C3.27188 4.23281 4.19531 3.30937 5.33906 3.30937C6.47813 3.30937 7.40156 4.23281 7.40156 5.37187C7.40156 6.50625 6.47813 7.43438 5.33906 7.43438ZM20.4516 20.4516H16.8937V14.8828C16.8937 13.5562 16.8703 11.8453 15.0422 11.8453C13.1906 11.8453 12.9094 13.2937 12.9094 14.7891V20.4516H9.35625V8.99531H12.7687V10.5609H12.8156C13.2891 9.66094 14.4516 8.70938 16.1813 8.70938C19.7859 8.70938 20.4516 11.0813 20.4516 14.1656V20.4516Z" fill="currentColor"/>
                          </svg></div></a>';
                      }
                      if (!empty($row["twitter_url"])) {
                          echo '<a href="'.$row["twitter_url"].'" class="social-link w-inline-block">';
                          echo '<div class="social-icon w-embed"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="logos-wrapper">
      <div class="logos-contain-2"><img src="images/uoft-logo-blue.svg" loading="lazy" alt="University of Toronto Faculty of Information Logo" class="logo-images-2"><img src="images/iccit_logo_navy2.png" loading="lazy" width="300" sizes="(max-width: 479px) 58vw, (max-width: 767px) 24vw, (max-width: 991px) 25vw, (max-width: 1439px) 21vw, 300px" alt="Institute of Communication Culture Information and Technology Logo" srcset="images/iccit_logo_navy2-p-500.png 500w, images/iccit_logo_navy2-p-800.png 800w, images/iccit_logo_navy2-p-1080.png 1080w, images/iccit_logo_navy2-p-1600.png 1600w, images/iccit_logo_navy2.png 1920w" class="logo-images-2"><img src="images/logo.svg" loading="lazy" width="300" alt="Victoria University Logo" class="logo-images-2"></div>
    </div>
  </div>
  <div class="footer">
